...
20.times{Realtor.create(name: Faker::Name.name, company: Faker::Company.name , location: Faker::Address.state, username: Faker::Lorem.word, email: Faker::Internet.email, password: Faker::Lorem.word, admin: Faker::Boolean.boolean(true_ratio: 0.5))}
